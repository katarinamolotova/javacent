...
import org.centrifugo.clients.interfaces.HistoryCommand;
import org.centrifugo.clients.interfaces.PresenceCommand;
import org.centrifugo.clients.interfaces.PublicationCommand;
import org.centrifugo.clients.interfaces.PushNotificationCommand;
import org.centrifugo.clients.interfaces.StatisticsCommand;
import org.centrifugo.clients.interfaces.TokenCommand;
import org.centrifugo.clients.interfaces.UserBlockCommand;
import org.centrifugo.clients.interfaces.UserStatusCommand;
        ...
        PresenceCommand, PublicationCommand, TokenCommand, StatisticsCommand, UserBlockCommand, UserStatusCommand
{
     ...
     */
    @Override
    public EmptyResponse deleteUserStatus(final List<String> users) {
        final DeleteUserStatusRequest request = new DeleteUserStatusRequest();
        return deleteUserStatus(request.setUsers(users));
    }
     ...
     */
    @Override
    public GetUserStatusResponse getUserStatus(final List<String> users) {
        final GetUserStatusRequest request = new GetUserStatusRequest();
        return getUserStatus(request.setUsers(users));
    }
     ...
     */
    @Override
    public EmptyResponse updateUserStatus(final List<String> users, final String state) {
        final UpdateUserStatusRequest request = new UpdateUserStatusRequest();
        return updateUserStatus(request.setUsers(users).setState(state));
    }
